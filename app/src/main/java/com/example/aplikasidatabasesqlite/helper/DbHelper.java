package com.example.aplikasidatabasesqlite.helper;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void update(int id, String name, String address){
        SQLiteDatabase database = this.getWritableDatabase();
        String queryValues = "UPDATE "+TABLE_SQLite+" SET " + COLUMN_NAME + "='"+name+"', "+COLUMN_ADDRESS+"='"+address+"'"+"WHERE " + COLUMN_ID + "='"+id+"'";
        Log.e("update sqlite ",""+queryValues);
        database.execSQL(queryValues);
        database.close();
    }
    ...
    public void delete(int id){
        ...
        Log.e("delete sqlite ",""+queryValues);
        database.execSQL(queryValues);
        database.close();
    }
